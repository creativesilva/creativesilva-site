...
| `curriculum/shared/photo2-composition-photowalk.html` | large=welcome-card, small=wrapper+triangle | grid auto-flow column + table vocab | DONE | 2026-08-21; first full module built in the locked system; bilingual; hero + 6-concept scroll box (slideshow photos) + 6-word vocab table + 4 steps + Lightroom presets; generated by scratchpad `build_photowalk.py` |
