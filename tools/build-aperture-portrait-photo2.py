...
# Images are per-slot (HAVE_* flags): HEADER + Step 3 reflection float are LIVE; Step 1/2 floats
# await art and render NOTHING until placed (no placeholder box). Camera-kit: NO fresh-photos note.
import os, re
