...
# ---------------- OVERVIEW ----------------
def overview():
    en=banner("Digital Arts 1A",f"Module {MOD}: Elements of Art, Character Design","Meet the first two Elements of Art: Line and Shape.","#espanol","Clic para Espa&ntilde;ol", HICON_DESIGN)
...
# ---------------- STEP 01 ----------------
def step01():
    en=banner(f"Module {MOD} &bull; Step 01","Draw Your Character","Sketch it, finalize it, name it.","#espanol","Clic para Espa&ntilde;ol", HICON_DESIGN)
    ...
    es=banner(f"M&oacute;dulo {MOD} &bull; Paso 01","Dibuja Tu Personaje","Boc&eacute;talo, final&iacute;zalo, nómbralo.","#top","Back to English", HICON_DESIGN)
