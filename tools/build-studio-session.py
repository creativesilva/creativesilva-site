...
def step02():
    ...
    en+=card("EDIT / LIGHTROOM CLASSIC","Cull, Edit, and Make 4 Finals",
        ...
        + scrollbox(7,
          stepblock(1,"Cull Your Best Frames","In the <strong>Library</strong> module, look through your whole take of your honoree. Select the frames where they look their best: eyes open, natural expression, sharp focus. Press <strong>P</strong> to flag your favorites, then work from those.")
