...
def step01():
    ...
    en+=card("BUILD YOUR POSTER","Cut Out, Blur, Finish",
        ...
        + stepblock(12,"Copy to a New Layer, Then Cut Out","After you rasterize, make a layer that fills the whole artboard. Press <strong>Command + A</strong> to Select All. Go to <strong>Edit &gt; Copy</strong>, then <strong>Edit &gt; Paste</strong>. Photoshop drops in a new layer the same size as your artboard. In the <strong>Layers</strong> panel, drag the old layer to the <strong>trash</strong> to delete it. Now click <strong>Select &gt; Subject</strong> to grab your subject, then click <strong>Select and Mask</strong>. Press <strong>V</strong> to set the View to <strong>Overlay</strong>, the red view, so your selection is easy to see. Clean the edges with the brush. At the bottom, set <strong>Output To: New Layer</strong>.")
    ...
    es+=card("CONSTRUYE TU P&Oacute;STER","Recorta, Desenfoca, Termina",
        ...
        + stepblock(12,"Copia a una Capa Nueva, Luego Recorta al Sujeto","Despu&eacute;s de rasterizar, haz una capa que llene todo el lienzo. Presiona <strong>Command + A</strong> para Seleccionar Todo. Ve a <strong>Edici&oacute;n &gt; Copiar</strong>, luego <strong>Edici&oacute;n &gt; Pegar</strong>. Photoshop coloca una capa nueva del mismo tama&ntilde;o que tu lienzo. En el panel de <strong>Capas</strong>, arrastra la capa vieja a la <strong>papelera</strong> para borrarla. Ahora haz clic en <strong>Seleccionar &gt; Sujeto</strong> para tomar a tu sujeto, luego haz clic en <strong>Seleccionar y Aplicar M&aacute;scara</strong>. Presiona <strong>V</strong> para poner la Vista en <strong>Superposici&oacute;n</strong>, la vista roja, para ver bien tu selecci&oacute;n. Limpia los bordes con el pincel. Abajo, pon <strong>Salida a: Nueva Capa</strong>.")
