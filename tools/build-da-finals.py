...
TEAL_TERM_BG = 'linear-gradient(135deg,rgba(0,184,184,0.20) 0%,rgba(0,184,184,0.20) 8%,rgba(0,0,0,0.40) 8%,rgba(0,0,0,0.40) 100%)'
TEAL_EYEBROW = '#80e0e0'
...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/logos/CS_AppIcon_180.png" />
