...
TEAL_TERM_BG = 'linear-gradient(135deg,rgba(0,184,184,0.16) 0%,rgba(0,184,184,0.16) 10%,rgba(0,0,0,0.34) 10%,rgba(0,0,0,0.34) 100%)'
TEAL_EYEBROW = '#80e0e0'
...
ORANGE_STAT_BG = 'linear-gradient(135deg,rgba(255,107,26,0.16) 0%,rgba(255,107,26,0.16) 10%,rgba(0,0,0,0.34) 10%,rgba(0,0,0,0.34) 100%)'
