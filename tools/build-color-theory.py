...
def overview():
    en=banner("Digital Arts 1A","Module 02: Color Theory","How color builds a brand.","#espanol","Clic para Espa&ntilde;ol", HICON_DESIGN)
    ...
    es=banner("Arte Digital 1A","M&oacute;dulo 02: Teor&iacute;a del Color","C&oacute;mo el color crea una marca.","#top","Back to English", HICON_DESIGN)
...
# ---------------- STEP 01 ----------------
def step01():
    en=banner("Module 02 &bull; Step 01","Brand Color Analysis","Homework: study a real brand.","#espanol","Clic para Espa&ntilde;ol", HICON_DESIGN)
    ...
    es=banner("M&oacute;dulo 02 &bull; Paso 01","An&aacute;lisis de Color de Marca","Tarea: estudia una marca real.","#top","Back to English", HICON_DESIGN)
