...
(function () {
  ...
  var MODULES = [
    ...
    ['/curriculum/shared/photo1-aperture-portrait-overview.html',
  ...
  var ACTIVE_LAST = groupIndexOf('/curriculum/shared/photo2-aperture-portrait-step03-reflection.html');
